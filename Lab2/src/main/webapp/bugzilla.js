...
function create(baseUrl){
	...
	/* LAB 3 Uncomment code which POSTs the form data from changerequest_creator.jsp to the 
	 * BugzillaChangeRequestService.createHtmlChangeRequest() service
...
function select(){
	...
	/* LAB 3 - Uncomment to send list of selected change requests from the delegated selection UI
...
function sendResponse(label, url) {
	...
	/* LAB 3 - Uncomment to send response via the OSLC windowName protocol or postMessage protocol as appropriate
